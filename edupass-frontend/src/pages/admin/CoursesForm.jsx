...
export default function CoursesForm() {
    ...
    const filteredInstitutions = useMemo(() => {
        ...
        const activeInstitutions = allInstitutions.filter(inst => inst.status === true);
                        ...
                        {({ isSubmitting, dirty, isValid, errors, touched }) => (
                            <Form className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label htmlFor="scholarshipYear" className="form-label">Ano da Bolsa*</label>
                                            <Field
                                                type="number"
                                            ...
                                            />
                                            <ErrorMessage name="scholarshipYear" component="div" className="form-error" />
                                    </div>
                                </div>
