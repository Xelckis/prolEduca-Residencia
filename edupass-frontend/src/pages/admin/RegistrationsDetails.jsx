...
const CheckCircleIcon = () => <CheckCircle className="w-5 h-5 text-green-600" />;
...
export default function RegistrationsDetails() {
  ...
  if (error) {
    return (
      <div className="p-8 bg-gray-100 min-h-screen">
        <Link to="/admin/registrations" className="flex items-center text-blue-600 hover:text-blue-800 mb-4">
  ...
  const rotaVoltar = String(status?.status || "").toLowerCase() === "pendente"
  ? "/admin/WaitList"
  : "/admin/registrations";
