        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center"> {/*  */}
          ...
          <div className="md:pl-4">
            ...
            <p className="text-lg text-blue-100 mb-4 leading-relaxed">
              O <span className="font-semibold text-white">Prol EduPass</span> é uma iniciativa da <span className="font-semibold text-white">Prol Educa</span>, nascida da crença no poder transformador da educação. Nossa missão é criar pontes entre estudantes, instituições de ensino e empresas, facilitando o acesso a bolsas de estudo e oportunidades reais de crescimento profissional e pessoal.
            </p>
            <p className="text-lg text-blue-100 mb-8 leading-relaxed">
              Acreditamos que aprender muda tudo — e que cada talento merece a chance de florescer.
            </p>
            <Link to="/quem-somos" className="inline-flex items-center gap-2 bg-[#F5F7F8] text-[#2F2F2F] font-semibold px-8 py-3 rounded-lg hover:text-[#30ADE7] transition-colors duration-300 shadow-lg text-base transform hover:scale-105 hover:shadow-[0_4px_12px_#1c8fc3]">Conheça a Prol Educa <FaArrowRight className="w-4 h-4" /></Link>
          </div>
        </div>
      </div>
    </section>
